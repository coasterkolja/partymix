        ...
        <div class="flex justify-between gap-2 items-center">
            ...
            <div class="flex items-center gap-2">
                ...
                <flux:tooltip content="Verlauf">
                    <flux:button href="{{ route('jams.history', $jam) }}" icon="clock" variant="ghost" size="sm" wire:navigate />
                </flux:tooltip>

                @host($jam)
                    <flux:tooltip content="Settings">
                        <flux:button href="{{ route('jams.edit', $jam) }}" icon="cog-6-tooth" variant="ghost" size="sm" wire:navigate />
                    </flux:tooltip>
                    
                    <flux:tooltip content="Warteschlange bearbeiten">
                        <flux:button href="{{ route('jams.queue', $jam) }}" icon="queue-list" variant="ghost" size="sm" wire:navigate />
                    </flux:tooltip>
                @endhost
            </div>
        </div>
